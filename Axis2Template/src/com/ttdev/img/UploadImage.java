...
package com.ttdev.img;

/**
 * UploadImage bean class
 */

public class UploadImage implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"urn:ttdev.com:service/img", "uploadImage", "ns1");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":uploadImage", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"uploadImage", xmlWriter);
			}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName("", "image"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static UploadImage parse(javax.xml.stream.XMLStreamReader reader)
			...
			try {
						...
						if (!"uploadImage".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (UploadImage) com.ttdev.img.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if (isReaderMTOMAware(reader)
						...
						object
								.setImage((javax.activation.DataHandler) reader
						...
						if (reader.getEventType() == javax.xml.stream.XMLStreamConstants.START_ELEMENT
							...
							object
									.setImage(((org.apache.axiom.soap.impl.builder.MTOMStAXSOAPModelBuilder) ((org.apache.axiom.om.impl.llom.OMStAXWrapper) reader)
							...
							object
									.setImage(org.apache.axis2.databinding.utils.ConverterUtil
