...
public class TestSer {
	...
	public static void main(String[] args) {
        ...
        try {
        	...
        	DeserializationContext dser = new DeserializationContext(new InputSource(reader), msgContext, Message.REQUEST);
        	dser.parse();
        	SOAPEnvelope env = dser.getEnvelope();
        	RPCElement rpcElem = (RPCElement)env.getFirstBody();
        	RPCParam struct = rpcElem.getParam("struct");
        	if (struct == null) throw new Exception("No <struct> param");
        	...
        	if(val == null) throw new Exception("No value for struct param");
